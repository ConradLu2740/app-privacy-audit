...
|------|------|------|------|------|------|-----------|
| A1 墨迹 | E-A1-sta-01/02 | E-A1-dyn-01/02 | E-A1-trf-01（受阻取证）· **E-A1-trf-02（60s 观测：535 连接/74 主机/50 明文 HTTP）** | E-A1-pol-01 | 6 | ✅ |
...
- A3 完整闭环
- **改进项（已于 2026-09-17 解决）：** ~~A1 流量未拿到「观测到」类证据~~ → E-A1-trf-02 已在首启后 60s 观测窗口内取到 535 条连接（74 独立主机，含 50 条明文 HTTP 与京东/GDT/穿山甲/高德/百度/个推/友盟等第三方域名）；本条升级为**通过**
